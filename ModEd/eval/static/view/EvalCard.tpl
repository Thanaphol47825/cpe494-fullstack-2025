...
>
  ...
  <div class="relative z-10">
    ...
    <p class="text-slate-600 mb-6 text-sm leading-relaxed min-h-[3rem]">
      {{card_description}}
    </p>
    ...
    <div class="space-y-3">
      ...
      >
        ...
        >
          <path
            ...
            stroke-linejoin="round"
            stroke-width="2"
            d="{{#create_icon}}{{create_icon}}{{/create_icon}}{{^create_icon}}M12 6v6m0 0v6m0-6h6m-6 0H6{{/create_icon}}"
          />
        </svg>
        {{create_text}}
      </button>
      ...
      <button
        ...
        class="w-full flex items-center justify-center gap-2 px-4 py-3 {{#manage_color}}{{manage_color}}{{/manage_color}}{{^manage_color}}bg-slate-700 hover:bg-slate-800{{/manage_color}} text-white rounded-xl transition-all duration-200 text-sm font-medium group-hover:shadow-lg"
      >
        <svg
          class="w-4 h-4"
          fill="none"
        ...
        >
          <path
            ...
            stroke-linejoin="round"
            stroke-width="2"
            d="{{#manage_icon}}{{manage_icon}}{{/manage_icon}}{{^manage_icon}}M4 6h16M4 10h16M4 14h16M4 18h16{{/manage_icon}}"
          />
        </svg>
        {{manage_text}}
      </button>
