...
class HrInstructorResignationFormFeature {
  ...
  async #createDynamicForm() {
    try {
      ...
      // Schema สำหรับ Instructor
      const schema = [
        { type: 'text', name: 'InstructorCode', label: 'Instructor Code', required: true },
        { type: 'textarea', name: 'Reason', label: 'Reason for Resignation', required: true }
      ];
        ...
        <div class="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 py-8">
          <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-10">
              ...
              <p class="text-gray-600">Send a resignation request for an instructor</p>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
              ...
              <div class="p-8">
                <div class="instructor-resignation-form-container"></div>
      ...
      const formRender = new FormRender(application, schema, '.instructor-resignation-form-container');
  ...
  #addCustomButtons() {
    ...
    const formContainer = document.querySelector('.instructor-resignation-form-container');
  ...
  #attachFormHandlers() {
    ...
    if (submitBtn) submitBtn.addEventListener('click', () => this.#handleSubmit(form));
  ...
  #validate(payload) {
    const missing = ['InstructorCode', 'Reason'].filter(f => !payload[f]);
    if (missing.length) {
      ...
      content.innerHTML = `
        <div class="flex items-center p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          <div>
            ...
            <p class="text-green-600">Instructor resignation submitted successfully</p>
        ...
        <div class="max-w-4xl mx-auto px-4">
          <div class="bg-red-50 border border-red-200 rounded-lg p-6">
            ...
            <div class="mt-4">
              ...
              <button onclick="window.location.href='${this.rootURL}/hr/resignation/instructor'" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 ml-3">Back</button>
            </div>
          </div>
        </div>
      </div>`;
