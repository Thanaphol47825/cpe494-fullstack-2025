...
type InternshipCriteria struct {
	...
	InternshipRegistrationId uint                   `gorm:"not null" csv:"internship_application_id" json:"internship_application_id"`
	InternshipRegistration   InternshipRegistration `gorm:"foreignKey:InternshipRegistrationId;references:ID"`
