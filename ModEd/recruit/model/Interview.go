...
type Interview struct {
	core.BaseModel
	InstructorID         uint               `json:"instructor_id" gorm:"not null" form:"label:Instructor;type:select;apiurl:/recruit/GetInstructorOptions"`
	...
	ApplicationReportID  uint               `json:"application_report_id" gorm:"not null" form:"label:Application Report;type:select;apiurl:/recruit/GetApplicationReportOptions"`
	...
	InterviewStatus      ApplicationStatus  `json:"interview_status" gorm:"type:varchar(20)" form:"label:Interview Status;type:select;apiurl:/recruit/GetApplicationStatusOptions"`
}
