...
<head>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {
            ...
            // Use HR Instructor Form Feature
            const instructorForm = new HrInstructorFormFeature(engine, RootURL);
            await instructorForm.render();
        });
            ...
            <div class="max-w-4xl mx-auto px-4 mb-8">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Create a new instructor using dynamic form generation</p>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8">
                    ...
                    <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                        <div class="flex items-center space-x-4">
                            ...
                            <button type="reset" form="instructorForm"
