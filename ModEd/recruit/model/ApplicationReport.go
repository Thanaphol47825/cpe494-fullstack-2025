...
type ApplicationReport struct {
	...
	Applicant   Applicant `gorm:"foreignKey:ApplicantID;references:ID" json:"-"`
	...
	ApplicationRound    ApplicationRound `gorm:"foreignKey:ApplicationRoundsID;references:ID" json:"-"`

	FacultyID uint           `json:"faculty_id" csv:"faculty_id" label:"Faculty ID" form:"number"`
	Faculty   *model.Faculty `gorm:"foreignKey:FacultyID;references:ID" json:"-"`

	DepartmentID uint              `json:"department_id" csv:"department_id" label:"Department ID" form:"number"`
	Department   *model.Department `gorm:"foreignKey:DepartmentID;references:ID" json:"-"`
