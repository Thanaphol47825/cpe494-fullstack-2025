  ...
  class HrStudentLeaveFormFeature {
    ...
    async render() {
      try {
        ...
        this.templateEngine.mainContainer.innerHTML = '';
        const errorPage = this.#createErrorPage(error.message || 'Unable to load student leave form.');
    ...
    #createPageContainer() {
      ...
      h1.textContent = 'Student Leave Request';
      
      const p = document.createElement('p');
      p.className = 'text-gray-600';
      p.textContent = 'Submit a new leave request for a student';
