  ...
  class HrStudentLeaveListFeature {
    ...
    async render() {
      try {
        ...
        this.templateEngine.mainContainer.innerHTML = '';
        const errorPage = this.#createErrorPage(error.message || 'Unable to load student leave requests.');
    ...
    #createPageContainer() {
      ...
      h1.textContent = 'Student Leave Requests';
      const p = document.createElement('p');
      p.className = 'text-gray-600';
      p.textContent = 'View and manage student leave requests';
      ...
      newRequestLink.setAttribute('routerLink', 'hr/leave/student/create');
    ...
    async #handleReview(requestId, action, reason) {
      try {
        ...
        await this.apiService.reviewStudentLeaveRequest(id, action, trimmedReason);
