...
if (typeof window !== 'undefined' && !window.HrStudentLeaveListFeature) {
  class HrStudentLeaveListFeature {
          ...
          <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="mb-6 flex justify-between items-center">
              <div class="flex gap-3">
                <a 
                  routerLink="hr/leave/student/create" 
    ...
    #generateEmptyState() {
      return `
        <div class="p-12 text-center">
          ...
          <p class="text-gray-500 mb-6">There are no student leave requests to display.</p>
          <a 
            routerLink="hr/leave/student/create" 
    ...
    #generateTableRow(request) {
      ...
      const leaveDate = request.leave_date ? new Date(request.leave_date).toLocaleDateString() : 'N/A';
      ...
      return `
        <tr class="hover:bg-gray-50">
          ...
          <td class="px-6 py-4 text-sm font-medium text-gray-900">${request.student_code || request.StudentCode || 'N/A'}</td>
          <td class="px-6 py-4 text-sm text-gray-700">${request.leave_type || request.LeaveType || 'N/A'}</td>
    ...
    async #handleReview(requestId, action, reason) {
      try {
        await this.apiService.reviewStudentLeaveRequest(requestId, action, reason);
